...
Since these two variables are correlated with each other, I will only be including one of them in the model.
...
1. **Electronic Check** - whether or not a customer's payment method is Electronic check.
2. **Has Service** - whether or not a customer as at least one of the following: online security, online backup, device protection, and tech support. 
